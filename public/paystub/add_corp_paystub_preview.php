...
include __DIR__ . "/engine-pay.js.php";   		// this does all the calcuatlions with the base info  $_request
    ...
    <table>
        ...
        <tr class="fontsize11">
            ...
            <td id="net_pay_ytd" class="tl-right">$net_pay_ytd</td>
              ...
              <!--<p id="tot_ded_prd"></p>
              <p id="tot_ded_ytd"></p>
              <p id="net_pay_ytd_deposit">$net_pay_ytd_deposit</p>
              <p id="check_num">$check_num</p> -->
...
echo $content;
				//$params1 = arrToParam($n2Vars);
			  //echo $params1."cccccccc";
?>