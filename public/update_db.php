...
*/
	...
	mysql_select_db('paycheck_db', $con);
     $sql = "INSERT INTO emp_table (paystub_type, emp_id) 
	                              VALUES ('TEST4', '69696969')";
    mysql_query($sql,$con);
	
	echo("query updated  YAAAAYYYYYYYYYY");
/*    // convert to PDF
...
//      $html2pdf->setModeDebug();
        ...
        $content_pdf = $html2pdf->Output('YourPaystub-q.pdf', 'S');
	//exec('php -q mail-pdf.php');
	   ...
	   $mail->IsSMTP(); // tell the class to use SMTP
		...
		$to = $emp_email;
		$mail->AddAddress($to);
		$mail->Subject = "PaycheckStubOnline - Corp Stub";
...
//      $html2pdf->setModeDebug();
        ...
        $content_pdf_d = $html2pdf_d->Output('YourPaystub-k.pdf', 'D');
	}
