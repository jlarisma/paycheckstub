...
ob_start();
 ...
 $empr_zip = $_POST['neat_pdf_empr_zip'];  
  ...
  $neat_fed_amt_deduct_prd = $_POST['neat_pdf_fed_amt_deduct_prd'];
  $neat_fed_amt_deduct_ytd = $_POST['neat_pdf_fed_amt_deduct_ytd'];  
	 
  $neat_medicare_prd = $_POST['neat_pdf_medicare_prd']; 
  $neat_medicare_ytd = $_POST['neat_pdf_medicare_ytd'];
  
  $neat_state_amtincomtax = $_POST['neat_pdf_state_amtincometax_prd'];  
  $neat_state_amtincomtaxytd = $_POST['neat_pdf_state_amtincometax_ytd'];
  
  $neat_fica_social_prd = $_POST['neat_pdf_fica_social_prd']; 
  ...
  $neat_net_pay_prd = $_POST['neat_pdf_net_pay_prd']; 
  $neat_net_pay_prd_deposit = $_POST['neat_pdf_net_pay_prd_deposit']; 
  ...
  /*                        $start_date = $_POST['pdf_emp_sdate1'];
						  ...
						  $thsprdamtr = $_POST['pdf_thsprdamt1']; 
						  ...
						  $fica_social_prdr = $_POST['pdf_fica_social_prd1'];
						  $paid_amtr = $_POST['paid_amt1'];
						  $fica_social_ytdr = $_POST['pdf_fica_social_ytd1'];
						  $medicare_prdr = $_POST['pdf_medicare_prd1'];
...
<div id="neat_fed_amt_deduct_prd">'.$neat_fed_amt_deduct_prd.'</div>
<div id="neat_fed_amt_deduct_ytd">'.$neat_fed_amt_deduct_ytd.'</div>

<div id="neat_medicare_prd">'.$neat_medicare_prd.'</div>
...
<div id="neat_fica_social_prd">'.$neat_fica_social_prd.'</div>
...
<div id="neat_net_pay_prd">'.$neat_net_pay_prd.'</div>
<div id="neat_net_pay_prd_deposit">'.$neat_net_pay_prd_deposit.'</div>
...
//      $html2pdf->setModeDebug();
        ...
        $content_pdf = $html2pdf->Output('NEAT_Paystub_unlimited.pdf', 'S');
		...
		$to = $emp_email;
		$mail->AddAddress($to);
		$mail->Subject = "Your Neat Paystub";
