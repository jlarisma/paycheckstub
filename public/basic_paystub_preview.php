...
#bc-paystub{
    ...
    !padding-left:5px;
    padding-right:33px;
background: url(http://www.paycheckstubonline.com/wp-content/uploads/2013/04/PREVIEW-paycheck-paystub-710.gif) no-repeat;
}
...
<div id="bc-paystub" style="border: solid 1px;" >
    <table class="x-subtotal-1" style="width:100%; border: solid 1px;" cellpadding="10">
        ...
        <tr class="x-input" style="height:24px">
            ...
            <td class="bd-right tl-right">$state_amtincometax_ytd</td>
