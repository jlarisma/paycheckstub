...
?>			
                  <tr id= <?php echo($i)?>>
                    ...
                    <td align="center">
						<a href="http://www.paycheckstubonline.com/pdf_renderdl.php?&aaa=<?php echo $stub_detail; ?>&stubidss=<?php echo $info_data->id;?>&payed=<?php echo $info_data->payed;?>&caps=<?php echo $info_data->caps;?>"  target="_blank">DOWNLOAD PAYSTUBS</a>
                    </td>
                    <td align="center">
						<a href="http://www.paycheckstubonline.com/pdf_renderdlbt.php?&aaa=<?php echo $stub_detail; ?>&stubidss=<?php echo $info_data->id;?>&payed=<?php echo $info_data->payed;?>&caps=<?php echo $info_data->caps;?>"  target="_blank">DOWNLOAD BANKSTATEMENT</a>
                    </td>
                    <td align="center">
                        <button id="record-email" name="emailfromaccount" value="<?php echo $stub_detail; ?>&stubidss=<?php echo $info_data->id;?>&payed=<?php echo $info_data->payed;?>&caps=<?php echo $info_data->caps;?>" class="email_btn_blue">E-MAIL</button> 
                    </td>
                    <td align="center">        
