...
function state_select(state) {
    ...
    /* d_corp.getElementById('corp_state_amtincometax_prd').innerHTML  =  (state_tax*val_multiplier).toFixed(2);				//corp screen
     d_corp.getElementById('corp_p_state_amtincometax_prd').value  =  (state_tax*val_multiplier).toFixed(2);			//corp_pdf
     d_corp.getElementById('corp_state_amtincometax_ytd').innerHTML  =  (state_tax*val_multiplier*num_period).toFixed(2);
     d_corp.getElementById('corp_p_state_amtincometax_ytd').value  =  (state_tax*val_multiplier*num_period).toFixed(2);
     d_basic.getElementById('basic_state_amtincometax_prd').innerHTML  =  (state_tax*val_multiplier).toFixed(2);				//corp screen
     d_basic.getElementById('basic_p_state_amtincometax_prd').value  =  (state_tax*val_multiplier).toFixed(2);			//corp_pdf
     d_basic.getElementById('basic_state_amtincometax_ytd').innerHTML  =  (state_tax*val_multiplier*num_period).toFixed(2);
     d_basic.getElementById('basic_p_state_amtincometax_ytd').value  =  (state_tax*val_multiplier*num_period).toFixed(2);
     d_neat.getElementById('neat_state_amtincometax_prd').innerHTML  =  (state_tax*val_multiplier).toFixed(2);				//corp screen
     d_neat.getElementById('neat_p_state_amtincometax_prd').value  =  (state_tax*val_multiplier).toFixed(2);			//corp_pdf
     d_neat.getElementById('neat_state_amtincometax_ytd').innerHTML  =  (state_tax*val_multiplier*num_period).toFixed(2);
     d_neat.getElementById('neat_p_state_amtincometax_ytd').value  =  (state_tax*val_multiplier*num_period).toFixed(2);

     d_w2.getElementById('w2_state_amtincometax').innerHTML  =  (state_tax).toFixed(2);				           //w2 screen net state taxes
     d_w2.getElementById('w2_p_state_amtincometax').value  =  (state_tax).toFixed(2);			//_pdf

     d_w2.getElementById('w2_p_state_abb').value  =  state_abbv;
     d_w2.getElementById('w2_state_abb').innerHTML  =  state_abbv;
     d_corp.getElementById('corp_p_state_abb').value  =  state_abbv;
     d_corp.getElementById('corp_state_abb').innerHTML  =  state_abbv;
     d_basic.getElementById('basic_p_state_abb').value  =  state_abbv;
     d_basic.getElementById('basic_state_abb').innerHTML  =  state_abbv;	
     d_neat.getElementById('neat_p_state_abb').value  =  state_abbv;
     d_neat.getElementById('neat_state_abb').innerHTML  =  state_abbv;	 
     */
}
